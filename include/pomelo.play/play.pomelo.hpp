...
namespace pomelo {
     ...
     */
    class [[eosio::contract("play.pomelo")]] playtoken : public contract {
        public:
            ...
            /**
             * Issue random quantity of tokens to user
             *
             * @param owner - the owner account to issue tokens to
             * @param symbol - the symbol of the token to execute the close action for.
             *
             * @pre The pair of owner plus symbol has to exist otherwise no action is executed,
             * @pre If the pair of owner plus symbol exists, the balance has to be zero.
            ...
            using issue_action = eosio::action_wrapper<"issue"_n, &playtoken::issue>;
            using retire_action = eosio::action_wrapper<"retire"_n, &playtoken::retire>;
            using transfer_action = eosio::action_wrapper<"transfer"_n, &playtoken::transfer>;
        ...
        private:
            ...
            const std::vector<uint64_t> FAUCET_VALUES = { 10, 50, 100, 500, 1000 };
